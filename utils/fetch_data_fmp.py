...
class FMP:
    ...
    def get_historical_daily_price(self, call_type, symbol, start_date, end_date, verbose=True):
        """
    ...
    def get_economic_index(self, symbol, start_date, end_date, verbose=True):
        """
    ...
    def get_historical_insider_trade_ticker(self, ticker, num_pages=1, verbose=True):
        """
    ...
    def get_stock_split_history(self, ticker, verbose=True):
        """
